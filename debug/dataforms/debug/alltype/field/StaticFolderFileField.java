...
/**
 * StaticFolderFileFieldフィールドクラス。
 *
 */
public class StaticFolderFileField extends FolderStoreFileField {
	 ...
	 * @param id フィールドID。
	 */
	public StaticFolderFileField(final String id) {
		super(id);
