...
public class EnumDao extends Dao {
	...
	public int insert(final Map<String, Object> data) throws Exception {
		return this.executeInsert(new EnumTable(), data);
	}
...
//		return this.executeRemove(new EnumTable(), data); // レコードの論理削除(DeleteFlagの設定)
		return this.executeDelete(new EnumTable(), data); // レコードの物理削除
	}
}
