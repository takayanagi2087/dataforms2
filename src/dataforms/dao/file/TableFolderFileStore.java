...
/**
 * テーブル,カラムに対応したフォルダに保存するファイルストアクラス。
 * <pre>
 ...
 * </pre>
 */
public class TableFolderFileStore extends FileStore {
	/**
	 * Logger。
	 */
	private Logger logger = LogManager.getLogger(TableFolderFileStore.class);
	 ...
	 * @param field フィールド。
	 */
	public TableFolderFileStore(final FileField<? extends FileObject> field) {
