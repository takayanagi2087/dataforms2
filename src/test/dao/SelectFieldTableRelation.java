...
/**
 * SelectTableの関係を定義するクラスです。
 *
 */
public class SelectFieldTableRelation extends TableRelation {
	...
	static {
		...
		// foreignKeyList.add(new ForeignKey("fkSelectTable01", SelectTable.Entity.ID_HOGE_ID, HogeTable.class));
	}
	 ...
	 * @param table 対象テーブル。
	 */
	public SelectFieldTableRelation(final Table table) {
		super(table);
	}
