 ...
 *
 */
public class SqlTypeListTable extends Table {
	/**
	 * コンストラクタ。
	 */
	public SqlTypeListTable() {
		this.setAutoIncrementId(true);
		this.setComment("SQLデータ型テストテーブル");
		this.addPkField(new SqlTypeListIdField()); //レコードID
	...
	public String getJoinCondition(final Table joinTable, final String alias) {
		SqlTypeListTableRelation r = new SqlTypeListTableRelation(this);
	...
	public static class Entity extends dataforms.dao.Entity {
		/** レコードIDのフィールドID。 */
		public static final String ID_SQL_TYPE_LIST_ID = "sqlTypeListId";
		/** レコードIDのフィールドID。 */
		...
		/**
		 * レコードIDを設定します。
		 * @param sqlTypeListId レコードID。
		 */
		public void setSqlTypeListId(final java.lang.Long sqlTypeListId) {
			this.getMap().put(Entity.ID_SQL_TYPE_LIST_ID, sqlTypeListId);
		}
	 ...
	 * @return レコードIDフィールド。
	 */
	public SqlTypeListIdField getSqlTypeListIdField() {
		return (SqlTypeListIdField) this.getField(Entity.ID_SQL_TYPE_LIST_ID);
	}
