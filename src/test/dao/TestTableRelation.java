...
/**
 * TestTableの関係を定義するクラスです。
 *
 */
public class TestTableRelation extends TableRelation {
	...
	static {
		 ...
		 */
		// foreignKeyList.add(new ForeignKey("fkTestTable01", TestTable.Entity.ID_HOGE_ID, HogeTable.class));
	}
	 ...
	 * @param table 対象テーブル。
	 */
	public TestTableRelation(final Table table) {
		super(table);
	}
