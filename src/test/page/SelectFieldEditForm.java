 ...
 * 編集フォームクラス。
 */
public class SelectFieldEditForm extends EditForm {
	/**
	 * コンストラクタ。
	 */
	public SelectFieldEditForm() {
		SelectFieldDao dao = new SelectFieldDao();
		this.addFields(dao);
	}
	...
	protected Map<String, Object> queryData(final Map<String, Object> data) throws Exception {
		SelectFieldDao dao = new SelectFieldDao(this);
