...
/**
 * SqlType2Tableの関係を定義するクラスです。
 *
 */
public class SqlType2TableRelation extends TableRelation {
	...
	static {
		 ...
		 */
		// foreignKeyList.add(new ForeignKey("fkSqlType2Table01", SqlType2Table.Entity.ID_HOGE_ID, HogeTable.class));
	}
	 ...
	 * @param table 対象テーブル。
	 */
	public SqlType2TableRelation(final Table table) {
		super(table);
	}
