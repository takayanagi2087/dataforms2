...
/**
 * SqlTimestampFieldフィールドクラス。
 *
 */
public class SqlTimestampField extends TimestampField {

	/**
	 * フィールドコメント。
	 */
	private static final String COMMENT = "TIMESTAMPフィールド";
	/**
	 * コンストラクタ。
	 */
	 ...
	 * @param id フィールドID。
	 */
	public SqlTimestampField(final String id) {
		super(id);
