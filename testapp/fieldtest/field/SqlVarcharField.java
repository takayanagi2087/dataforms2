...
/**
 * SqlVarcharFieldフィールドクラス。
 *
 */
public class SqlVarcharField extends VarcharField {
	/**
	 * フィールド長。
	 */
	 ...
	 * フィールドコメント。
	 */
	private static final String COMMENT = "VarcharField";
	/**
	 * コンストラクタ。
	 */
	public SqlVarcharField() {
		this(null);
	}
	/**
	 * コンストラクタ。
	 * @param id フィールドID。
	 */
	public SqlVarcharField(final String id) {
		super(id, LENGTH);
