 ...
 * ページクラス。
 */
public class MultiRecPage extends BasePage {
	/**
	 * コンストラクタ。
	 */
	public MultiRecPage() {
		this.addForm(new MultiRecQueryForm());
		this.addForm(new MultiRecQueryResultForm());
		this.addForm(new MultiRecEditForm());
