...
import pagepat.dao.MultiRecDao;
 ...
 * 問い合わせ結果フォームクラス。
 */
public class MultiRecQueryResultForm extends QueryResultForm {
	/**
	 * コンストラクタ。
	 */
	public MultiRecQueryResultForm() {
		MultiRecDao dao = new MultiRecDao();
		...
		htmltable.getFieldList().get(Code1CountQuery.Entity.ID_CODE2_COUNT).setSortable(true);
	...
	protected Map<String, Object> queryPage(final Map<String, Object> data, final FieldList queryFormFieldList) throws Exception {
		MultiRecDao dao = new MultiRecDao(this);
